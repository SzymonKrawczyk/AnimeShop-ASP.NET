...
namespace AnimeShop.Controllers {
    ...
    public class ManageController : Controller {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message) {
            ...
            //string role = User.IsInRole("admin") ? "admin" : User.IsInRole("user") ? "user" : "error";
            //ViewData["role"] = role;
            ...
            if (User.IsInRole("admin")) {
                ...
                ViewData["categories"] = db.Categories.OrderBy(c => c.Name);
                ViewData["shipments"] = db.Shipments.OrderByDescending(s => s.Active).ThenBy(s => s.Name);
                ViewData["products"] = db.Products.OrderByDescending(p => p.Active).ThenBy(p => p.Name);

                ViewData["orders"] = db.Orders.Include(o => o.OrderLists).Include(o => o.Shipment).Include(o => o.Status).OrderBy(o => o.Status.Name).ThenBy(o => o.Date);

            } else if (User.IsInRole("user")) {

                if (customer != null) {

                    ViewData["orders"] = db.Orders.Where(o => o.Customer.CustomerModelId == customer.CustomerModelId).Include(o => o.OrderLists).Include(o => o.Shipment).Include(o => o.Status).OrderBy(o => o.Status.Name).ThenBy(o => o.Date);
